        ...
        <Card key={complejo.id_complejo} className="cardComplejo my-2">
            ...
            <div className='complejoCardDatos'>
              ...
              <div className='botonesCardComplejos gap-2 pr-5'>
                <Button variant="bordered" size="sm" className="botonCardComplejo botonVerMapa" onClick={() => {cambiarPosicionZoom(complejo.latitud, complejo.longitud, 15, complejo.id_complejo);}}>
