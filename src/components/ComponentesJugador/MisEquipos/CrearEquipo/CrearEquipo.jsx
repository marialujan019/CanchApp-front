            ...
            <Modal.Body className='modalEDContainer'>
                ...
                <div className='modalReservaTextoContainer'>
                    ...
                    <form
                        ...
                        className='formularioCrearEquipoContainer'
                    >
                        <div>
                        ...
                        <div>
                            <label className='my-1'>
                                ...
                                <select
                                    name='publico'
                                    value={
                                        equipo.publico ? "publico" : "privado"
                                    }
                            ...
                            {equipo.publico ? (
                                <p className='mensajeCrearEquipo'>
                                    Su equipo será visible en la búsqueda de
                                    jugadores.
                                </p>
                            ) : (
                                <p className='mensajeCrearEquipo'>
                                    Su equipo no será visible en la búsqueda de
                                    jugadores.
                                </p>
                            )}
                            <br />
