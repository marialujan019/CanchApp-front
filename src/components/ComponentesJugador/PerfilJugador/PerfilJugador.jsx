...
const PerfilJugador = ({
    ...
    useEffect(() => {
        axios
            .post("http://localhost:3001/perfil", {
                tipo: "jugador",
                id: id,
            })
            .then((res) => {
    ...
    const handleGuardarPieHabil = (valorSeleccionado) => {
        console.log(
            "Pie habil editado:",
            valorSeleccionado === "Prefiero no decirlo"
                ? null
                : valorSeleccionado
        );
        axios.put(`http://localhost:3001/perfil/update/${id}`, {
                                ...
                                {editandoMail ? (
                                    <div>
                                        <input
                                            ...
                                            value={mailEditado}
                                            onChange={(e) =>
                                                setMailEditado(e.target.value)
                                            }
                                        />
                                        <button onClick={handleGuardarMail}>
                                            Guardar
                                        </button>
                                    </div>
                                ) : (
                                    <p>
                                        {mail}{" "}
                                        <button onClick={handleEditarMail}>
                                            Editar
                                        </button>
                                    </p>
                                )}
                            ...
                            <div className='data'>
                                ...
                                {editandoTelefono ? (
                                    <div>
                                        ...
                                        />
                                        <button onClick={handleGuardarTelefono}>
                                            Guardar
                                        </button>
                                    </div>
                                ) : (
                                    <p>
                                        {telefono}{" "}
                                        <button onClick={handleEditarTelefono}>
                                            Editar
                                        </button>
                                    </p>
                                )}
                            ...
                            <div className='data'>
                                ...
                                {editandoSexo ? (
                                    <div>
                                        ...
                                        <button onClick={handleGuardarSexo}>
                                            Guardar
                                        </button>
                                    </div>
                                ) : (
                                    <p>
                                        {sexo}{" "}
                                        <button onClick={handleEditarSexo}>
                                            Editar
                                        </button>
                                    </p>
                                )}
                                ...
                                {editandoPieHabil ? (
                                    ...
                                    <p>
                                        {pieHabil == null
                                            ? "Prefiero no decirlo"
                                            : pieHabil}
                                        <button onClick={handleEditarPieHabil}>
                                            Editar
                                        </button>
                                    </p>
                                )}
                                ...
                                {editandoPosicion ? (
                                    ...
                                    <p>
                                        {posicion === null
                                            ? "Prefiero no decirlo"
                                            : posicion}{" "}
                                        <button onClick={handleEditarPosicion}>
                                            Editar
                                        </button>
                                    </p>
                                )}
