...
import Calendario from "./components/ComponentesAdministrador/Calendario/Calendario";
                        ...
                        <div className='App'>
                            <BrowserRouter>
                                ...
                                <Routes>
                                    ...
                                    <Route
                                        path='/buscarjugador'
                                        element={<BusquedaJugador />}
                                    />
                                    <Route
                                        path='/buscarequipo/:id_jugador'
                                        element={<BusquedaEquipo />}
                                    />

                                    {/* Complejo */}
                                    <Route path='/mapa' element={<Mapa />} />
                                    <Route
                                        path='/complejo/:id_complejo'
                                        element={<Complejo />}
                                    />
